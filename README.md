...
### Contests
- [ ] [Educational DP contest on AtCoder](https://atcoder.jp/contests/dp) (7/26)
...
- [x] [Prime Path](https://www.spoj.com/problems/PPATH/)

#### Strongly Connected Components

- [x] [The Bottom of a Graph](https://www.spoj.com/problems/BOTTOM/)
- [x] [Fake Tournament](https://www.spoj.com/problems/TOUR/)
...
- [x] [:movie_camera:](https://www.youtube.com/watch?v=pSqmAO-m7Lk)[Dijkstra's Shortest path](https://cp-algorithms.com/graph/dijkstra_sparse.html)
